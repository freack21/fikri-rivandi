      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-16">
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium uppercase tracking-wider">Clients</p>
              </div>
            </div>
            
            <div className="mt-12 pt-12 border-t border-gray-200">
              <h3 className="text-xl font-bold text-gray-900 mb-6 tracking-tight">Tech Stack & Tools</h3>
              <div className="flex flex-wrap gap-2.5">
                {resumeData.skills.map((skill, index) => (
                  <span 
                    key={index} 
                    className="px-4 py-2 bg-white border border-gray-200 text-gray-700 text-sm font-medium rounded-full shadow-sm hover:border-primary hover:text-primary transition-colors cursor-default"
                  >
                    {skill}
                  </span>
                ))}
          ...
          <div className="w-full md:w-1/2 relative">
            ...
            <div className="absolute -top-6 -right-6 w-24 h-24 bg-gray-200 rounded-full -z-10 opacity-50"></div>
          </div>
